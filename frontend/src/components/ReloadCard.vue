  ...
  <v-col cols="12" xs="12" sm="12" md="6" lg="4">
    <v-card class="px-8 pt-8 card" outlined>
      ...
      <p class="mt-4">
        ...
        <a :href="url4" target="_blank" rel="noopener">nodemon</a> to
        auto-restart the server. nodemon is activated by starting the server in
        development mode. The command is located in
        <code>
...
export default {
  ...
  data: () => ({
    ...
    url4: 'https://github.com/remy/nodemon',
    url5: `${process.env.VUE_APP_STARTER_REPO_URL}backend/package.json#L6`
  }),
  methods: {
    highlighter(code) {
